      ...
      <div className="w-full sticky top-0 z-50 ">
        <div className="w-full relative bg-amazon_blue text-white px-1 py-1 xl:px-4 md:py-3 flex items-center  flex-wrap gap-1 xl:gap-4">
          ...
          <div className="   h-9 xl:h-10 rounded-md   order-last  md:order-none  flex items-center flex-grow   flex-shrink-0 md:flex-shrink  relative  ">
            <div className=" h-full hidden  md:block" ref={catMenu}>
              <span
            ...
            <input
              className="h-full  text-base rounded-l-md md:rounded-l-none text-amazon_blue flex-grow outline-none border-none px-2"
              type="text"
              placeholder="Search..."
              value={search}
            ...
            <Link
              to="/"
              className="w-8 md:w-12 h-full flex items-center justify-center bg-amazon_yellow hover:bg-[#f3a847] duration-300 text-amazon_blue cursor-pointer rounded-tr-md rounded-br-md"
            >
              <span>
